  ...
  return (
    <ProtectedShell>
      <PageHeader
        ...
        title="GitHub"
        description="Connect your own GitHub account. Patchline X never sees your password, and the token is encrypted at rest."
      />
          ...
          {confirmingDisconnect && (
            <div className="mt-4 pt-4 border-t border-border-strong">
              ...
              <p className="text-muted text-sm mb-3">
                This revokes Patchline X&apos;s access token at GitHub{watchedCount ? (
