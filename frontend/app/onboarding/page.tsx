        ...
        <Card className="p-8 shadow-2xl">
          ...
          {step === 1 && (
            <StepCard
              ...
              description="Patchline X scans your repositories, checks AST syntax, and opens tested pull requests once fixes are approved."
          ...
          {step === 2 && (
            <StepCard
              ...
              description="Optional — Patchline X automatically creates tracked Jira issue tickets for discovered high-severity vulnerabilities."
