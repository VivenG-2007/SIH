    ...
    <ProtectedShell>
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          ...
          {/* ── Row 4b: Security Investment Optimizer — Section 8 of the
               SIH architecture (exact knapsack solver), previously built
               and tested on the backend with no frontend consumer ── */}
          <InvestmentOptimizer />
