#!/usr/bin/env python3
"""Validate patchlinex-rules.yml against the annotated fixtures in this
...
says it should, or if any rule in patchlinex-rules.yml never fires in any
...
RULES_FILE = "patchlinex-rules.yml"
...
def main() -> int:
    ...
    if not fixture_files:
        sys.exit("No test_* fixture files found next to patchlinex-rules.yml")
