...
// See src/config/redis.js for the full rationale — same USE_REDIS_MOCK
// swap, set only by test/setup-env.js, so BullMQ's queues never dial a
// real Redis during `node --test`.
